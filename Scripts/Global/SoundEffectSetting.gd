...
@export var type: Utility.SOUND_EFFECT_TYPE = Utility.SOUND_EFFECT_TYPE.BASE ## The unique sound effect in the [enum SOUND_EFFECT_TYPE] to associate with this effect. Each SoundEffect resource should have it's own unique [enum SOUND_EFFECT_TYPE] setting.
